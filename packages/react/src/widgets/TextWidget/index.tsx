...
import { isStr, isPlainObj } from '@kep-platform/designable-shared'
import { GlobalRegistry, IDesignerMiniLocales } from '@kep-platform/designable-core'
...
export const TextWidget: React.FC<ITextWidgetProps> = observer((props) => {
	...
	return <Fragment>{takeMessage(props.children) || takeMessage(props.token) || takeMessage(props.defaultMessage)}</Fragment>
})
