...
import { Engine, DragStartEvent, DragMoveEvent, DragStopEvent, CursorDragType } from '@kep-platform/designable-core'
import { calcSpeedFactor, createUniformSpeedAnimation } from '@kep-platform/designable-shared'
...
const useResizeEffect = (container: React.MutableRefObject<HTMLDivElement>, content: React.MutableRefObject<HTMLDivElement>, engine: Engine) => {
...
export const ResponsiveSimulator: React.FC<IResponsiveSimulatorProps> = observer((props) => {
