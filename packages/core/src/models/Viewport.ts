import { calcBoundingRect, calcElementLayout, cancelIdle, globalThisPolyfill, IPoint, IRect, isHTMLElement, isPointInRect, isRectInRect, Rect, requestIdle } from '@kep-platform/designable-shared'
