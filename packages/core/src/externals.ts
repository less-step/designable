...
import { IBehavior, IBehaviorCreator, IBehaviorHost, IDesignerLocales, IEngineProps, IResource, IResourceCreator, IResourceHost } from './types'
...
export const isBehavior = (val: any): val is IBehavior => val?.name || val?.selector || val?.extends || val?.designerProps || val?.designerLocales
