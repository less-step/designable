...
export const BoxShadowStyleSetter: React.FC<IBoxShadowStyleSetterProps> = observer((props) => {
	...
	return (
		<FoldItem className={cls(prefix, props.className)} style={props.style} label={field.title}>
			<FoldItem.Base>
