...
import { TextWidget, IconWidget, usePrefix, useTheme } from '@kep-platform/designable-react'
import * as monaco from 'monaco-editor/esm/vs/editor/editor.api'
import { Tooltip } from 'antd'
import { parseExpression, parse } from '@babel/parser'
import { uid } from '@kep-platform/designable-shared'
...
export const MonacoInput: React.FC<MonacoInputProps> & {
	...
	const renderHelper = () => {
		...
		return (
			href && (
				<Tooltip title={<TextWidget token="SettingComponents.MonacoInput.helpDocument" />}>
